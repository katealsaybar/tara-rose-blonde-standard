...
Same evening, the proof grows lanes: under the hero pair now sit two
compact lane-labelled pairs. **Soft Blonde** is frame-grabbed from the
salon's own clips (BRIT6742 4K / BRIT7002 1080p, one client, staff-checked,
sharpest frames picked by Laplacian score, Kate approved the crops).
**Signature Blonde** is split out of the salon's published socials
composite (25.png in the tara-owned before/after folder, seam-detected,
